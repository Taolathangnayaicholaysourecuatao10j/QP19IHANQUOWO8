...
local game = game.PlaceId
        if game == 2753915549 then
    World1 = true; 
else
        if game == 4442272183 then
    World2 = true;
else
        if game == 7449423635 then 
    World3 = true; 
else 
...
local Window = XSeaH:CreateWindow({
    Title = "<font color='rgb(204, 255, 255)'>X-Sea Update One</font>",
    SubTitle = "<font color='rgb(0, 240, 156)'></font>".." - "..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name ,
    TabWidth = 150,
...
local Info = Window:AddTab({Title = "Update", Icon = "Sun-snow"})
...
local function UpdateOS()
    ...
    function function8()
        ...
        local Main = Window:AddTab({Title = "Main1", Icon = "home"})
...
local ListF = Main:AddDropdown("ListF", {
    Title = "Mode Farm",
    Description = "select Quest or Normal or Near Farming",
    Values = ListF,
    Multi = false,
    Default = FarmMode,
    Callback = function(v)
...
local BringToi = {"Low", "Normal", "High"}
_G.BringMode = "Normal"
local BringMode = Set:AddDropdown("BringMode", {
...
local AutoClick = Set:AddToggle("AutoClick", {
    Title = "Auto Click",
    Description = "Should turn on when You need it!",
    Default = false ,
