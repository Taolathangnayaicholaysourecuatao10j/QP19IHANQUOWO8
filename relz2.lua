...
ImageButton.Image = "http://www.roblox.com/asset/?id=17893549447"
...
local Tabs = {
    Infor = Window:AddTab({ Title = "Update Log + Discord", Icon = "" }),
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://10723407389" }),
    Subb = Window:AddTab({ Title = "Sub Farming", Icon = "rbxassetid://10709769841" }),
    Stat = Window:AddTab({ Title = "Stats Player", Icon = "rbxassetid://10709770317" }),
    Con = Window:AddTab({ Title = "Config Farming", Icon = "rbxassetid://10734984606" }),
    Pla = Window:AddTab({ Title = "Player", Icon = "rbxassetid://10734984606" })
    Fruits = Window:AddTab({ Title = "Devils Fruits", Icon = "rbxassetid://10709761889" }),
    Sea = Window:AddTab({ Title = "Sea Event", Icon = "rbxassetid://10709761530" }),
    Ra = Window:AddTab({ Title = "Raid", Icon = "rbxassetid://10723345749" }),
    V4 = Window:AddTab({ Title = "Trial V4", Icon = "rbxassetid://10734984606" }),
    Tele = Window:AddTab({ Title = "teleport Islands", Icon = "rbxassetid://10723434557" }),
    Mis = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://10723424838" }),
    Sh = Window:AddTab({ Title = "Shops", Icon = "rbxassetid://10734952479" }),
}
...
local Dropdown = Tabs.Con:AddDropdown("Dropdown", {
    Title = "Select Weapon",
...
if World1 then
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Farm Fast level 10-75", Default = false })
