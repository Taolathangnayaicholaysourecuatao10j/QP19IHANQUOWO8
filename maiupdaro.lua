...
local Tabs = {
    ...
    Subb = Window:AddTab({ Title = "Stack Farm", Icon = "" }),
    Settings = Window:AddTab({ Title = "Setting Farm", Icon = "" }),   
    Mt = Window:AddTab({ Title = "Material Farm", Icon = "" }),
    De = Window:AddTab({ Title = "Fruit & Dungeon", Icon = "" }),    
    St = Window:AddTab({ Title = "Status Sever", Icon = "" }),
    Se = Window:AddTab({ Title = "Sea Event", Icon = "" }),
    RC = Window:AddTab({ Title = "Race V4", Icon = "" }),  
    Qs = Window:AddTab({ Title = "Update Race", Icon = "" }),  
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
    ...
    Tabs.Sh:AddButton({
        Title = "l Observation haki [$ 750,000 Beli ]",
        Description = "",
        Callback = function()            
...
spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "On busso haki", Default = false })
...
local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Turn Haki Ob", Default = false })
   ...
   local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Fast Attack + Auto Click ", Default = true })

    Toggle:OnChanged(function(Value)
      UFFF = Value
    end)
      
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Fast Delay 2", Default = false })
...
local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Auto Click 0s", Default = false })
...
spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Remove all Notification", Default = false })
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Remove text when farming mob", Default = false })
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Bring Monster", Default = true })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Kill Nearest", Default = false })
...
spawn(function()
    ...
    Tabs.Main:AddSection("Quest All Sea")
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Quest Sea2", Default = false })
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Farm Mastery Fruits", Default = false })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Mastery Gunn", Default = false })
...
spawn(function()
    ...
    Tabs.Subb:AddSection("Bone")
    
    local Toggle = Tabs.Subb:AddToggle("MyToggle", {Title = "Auto Farm Bone", Default = false })
    ...
    local Toggle = Tabs.Subb:AddToggle("MyToggle", {Title = "Random Bone", Default = false })
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Farm Cake + Spawn Cake", Default = false })
    ...
    Tabs.Subb:AddParagraph({
        Title = "Event",
        Content = ""
    })
    
    local Toggle = Tabs.Subb:AddToggle("MyToggle", {Title = "Attack Factory", Default = false })
    ...
    StopTween(_G.AutoFactory)
        ...
        local Toggle = Tabs.Subb:AddToggle("MyToggle", {Title = "Attack Pirate Raid [Sea3]", Default = false })
 ...
 local ObservationRange = Tabs.Subb:AddParagraph({
        Title = "Observe Level",
        Content = ""
    })
    ...
    local Toggle = Tabs.Subb:AddToggle("MyToggle", {Title = "Farm Level Observe", Default = false })
    ...
    local Toggle = Tabs.Subb:AddToggle("MyToggle", {Title = "Auto Observation V2", Default = false })
...
if _G.ChestBypass then
 ...
 local Toggle = Tabs.Subb:AddToggle("MyToggle", {Title = "Auto Kill Elite Hunter", Default = false })
 ...
 local Toggle = Tabs.Subb:AddToggle("MyToggle", {Title = "Auto Kill Rip Indra", Default = false })
 ...
 spawn(function()
    ...
    local Toggle = Tabs.Subb:AddToggle("MyToggle", {Title = "Kill Dough King V2", Default = false })
 ...
 local Toggle = Tabs.Subb:AddToggle("MyToggle", {Title = "Auto Kill black beard", Default = false })
 ...
 spawn(function()
    ...
    local Toggle = Tabs.Subb:AddToggle("MyToggle", {Title = "Auto Soul Reaper", Default = false })
    ...
    local Toggle = Tabs.Mt:AddToggle("MyToggle", {Title = "Auto Farm ", Default = false })
...
local Toggle = Tabs.Mt:AddToggle("MyToggle", {Title = "Auto Farm Ectoplasm", Default = false })
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Auto Store Fruits", Default = false })
  ...
  "Leopard-Leopard"
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Buy Fruit slect", Default = false })
...
"Tiki Outpost"},
    ...
    local Toggle = Tabs.Lc:AddToggle("MyToggle", {Title = "Teleport Islands[Tween]", Default = false })
...
"Tiki Outpost"},
    ...
    Tabs.Lc:AddButton({
        Title = "Teleporter To Island's [Bypass]",
        Description = "",
        Callback = function()
...
while wait() do 
    ...
    Tabs.Qs:AddSection("other Sea 1")
    
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Get Saber", Default = false })
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Get  Yama", Default = false })
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Get Tushiata", Default = false })
...
spawn(function()
 ...
 --[[   local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Get Cursed Dual Katana", Default = false })
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Get Quest Soul Guitar[Beta]", Default = false })
...
ImageButton1.Image = "rbxassetid://17851124858"
